    ...
    if poczatekFe != -1 and koniecFe != -1:
        for kolumna in range(poczatekFe, koniecFe + 1):
            ...
            if Tabelarzadwiazania[wiersz][kolumna] > promienodcieciaFe:
                Fe += 1
                TabelarzadwiazaniaO[wiersz2][i +
                                             Fe] = Tabelarzadwiazania[wiersz][kolumna]
    tablicaFe.append(Fe)
    if poczatekAl != -1 and koniecAl != -1:
        for kolumna in range(poczatekAl, (koniecAl + 1)):
            ...
            if Tabelarzadwiazania[wiersz][kolumna] > promienodcieciaAl:
                Al += 1
                TabelarzadwiazaniaO[wiersz2][i + Fe +
                                             Al] = Tabelarzadwiazania[wiersz][kolumna]
    tablicaAl.append(Al)
    if poczatekX != -1 and koniecX != -1:
        for kolumna in range(poczatekX, (koniecX + 1)):
            ...
            if Tabelarzadwiazania[wiersz][kolumna] > promienodcieciaX:
                X += 1
                TabelarzadwiazaniaO[wiersz2][i + Fe + Al +
                                             X] = Tabelarzadwiazania[wiersz][kolumna]
    tablicaX.append(X)
    wiersz2 += 1
...
przedzialh = (Tabelarzadwiazania[maximumido][maximumidp] -
              Tabelarzadwiazania[minimumido][minimumidp]) / ilosckolumnh
przedzialhFe = (Tabelarzadwiazania[maximumidoFe][maximumidFe] -
                Tabelarzadwiazania[minimumidoFe][minimumidFe]) / ilosckolumnh
przedzialhAl = (Tabelarzadwiazania[maximumidoAl][maximumidAl] -
                Tabelarzadwiazania[minimumidoAl][minimumidAl]) / ilosckolumnh
przedzialhFeFe = (Tabelarzadwiazania[maximumidFeFe][maximumidFeFe2] -
                  Tabelarzadwiazania[minimumidFeFe][minimumidFeFe2]) / ilosckolumnh
przedzialhAlAl = (Tabelarzadwiazania[maximumidAlAl][maximumidAlAl2] -
                  Tabelarzadwiazania[minimumidAlAl][minimumidAlAl2]) / ilosckolumnh
...
histogram(ilosckolumnh, przedzialh, poczatekO, koniecO, poczatekP, koniecP,
          dolnagranica, gornagranica, minimumido, minimumidp, "histogram P-O")

# histogramFe-O

gornagranica = Tabelarzadwiazania[minimumidoFe][minimumidFe] + \
    przedzialhFe + 0.0001
dolnagranica = Tabelarzadwiazania[minimumidoFe][minimumidFe]

histogram(ilosckolumnh, przedzialhFe, poczatekO, koniecO, poczatekFe, koniecFe,
          dolnagranica, gornagranica, minimumidoFe, minimumidFe, "histogram Fe-O")

# histogramAl-O

gornagranica = Tabelarzadwiazania[minimumidoAl][minimumidAl] + \
    przedzialhAl + 0.0001
dolnagranica = Tabelarzadwiazania[minimumidoAl][minimumidAl]

histogram(ilosckolumnh, przedzialhAl, poczatekO, koniecO, poczatekAl, koniecAl,
          dolnagranica, gornagranica, minimumidoAl, minimumidAl, "histogram Al-O")


# histogramFe-Fe
gornagranica = Tabelarzadwiazania[minimumidFeFe][minimumidFeFe2] + \
    przedzialhFeFe + 0.0001
dolnagranica = Tabelarzadwiazania[minimumidFeFe][minimumidFeFe2]

histogram(ilosckolumnh, przedzialhFeFe, poczatekFe, koniecFe, poczatekFe, koniecFe,
          dolnagranica, gornagranica, minimumidFeFe, minimumidFeFe2, "histogram Fe-Fe")

# histogramAl-Al
gornagranica = Tabelarzadwiazania[minimumidAlAl][minimumidAlAl2] + \
    przedzialhAlAl + 0.0001
dolnagranica = Tabelarzadwiazania[minimumidAlAl][minimumidAlAl2]

histogram(ilosckolumnh, przedzialhAlAl, poczatekAl, koniecAl, poczatekAl, koniecAl,
          dolnagranica, gornagranica, minimumidAlAl, minimumidAlAl2, "histogram Al-Al")
...
for x in range(0, koniecO - poczatekO + 1):
    print(poczatekO + 1 + x, " ", tablicaOP[x], tablicaOP2[x], tablicaFe[x], tablicaAl[x], " ", TabelarzadwiazaniaO[x][1], TabelarzadwiazaniaO[x][2], TabelarzadwiazaniaO[x]
          [3], TabelarzadwiazaniaO[x][4], TabelarzadwiazaniaO[x][5], TabelarzadwiazaniaO[x][6], TabelarzadwiazaniaO[x][7], TabelarzadwiazaniaO[x][8], TabelarzadwiazaniaO[x][9])
    if tablicaOP[x] == 0:
        ilosc0 += 1
    if tablicaOP[x] == 1:
        ilosc1 += 1
...
print()
print()
koordynacja(poczatekP, koniecP, poczatekO, koniecO,
            promienodcieciapo, "P, koordynacja do tlenu")
# koordynacjaFe
print()
print()
koordynacja(poczatekFe, koniecFe, poczatekO, koniecO,
            promienodcieciaFe, "Fe, koordynacja do tlenu")

# koordynacjaAl
print()
print()
koordynacja(poczatekAl, koniecAl, poczatekO, koniecO,
            promienodcieciaAl, "Al, koordynacja do tlenu")
...
print()
print()
koordynacja(poczatekFe, koniecFe, poczatekFe, koniecFe,
            promienodcieciaFeFe, "Fe-Fe, koordynacja")

# koordynacjaAlAl
print()
print()
koordynacja(poczatekAl, koniecAl, poczatekAl, koniecAl,
            promienodcieciaAlAl, "Al-Al, koordynacja")

# koordynacjaPP
print()
print()
koordynacja(poczatekP, koniecP, poczatekP, koniecP,
            promienodcieciaPP, "P-P, koordynacja")

# koordynacjaPFe
print()
print()
koordynacja(poczatekP, koniecP, poczatekFe, koniecFe,
            promienodcieciaPFe, "P-Fe, koordynacja")

# koordynacjaPAl
print()
print()
koordynacja(poczatekP, koniecP, poczatekAl, koniecAl,
            promienodcieciaPAl, "P-Al, koordynacja")

# koordynacjaFeAl
print()
print()
koordynacja(poczatekFe, koniecFe, poczatekAl, koniecAl,
            promienodcieciaFeAl, "Fe-Al, koordynacja")
...
rzadwiazania_dlugoscwiazania(
    "P", "O", promienodcieciapo, poczatekP, koniecP, poczatekO, koniecO)
print()
print()
rzadwiazania_dlugoscwiazania(
    "Fe", "O", promienodcieciaFe, poczatekFe, koniecFe, poczatekO, koniecO)
print()
print()
rzadwiazania_dlugoscwiazania(
    "Al", "O", promienodcieciaAl, poczatekAl, koniecAl, poczatekO, koniecO)
print()
print()
rzadwiazania_dlugoscwiazania(
    nazwaX, "O", promienodcieciaX, poczatekX, koniecX, poczatekO, koniecO)
print()
print()
rzadwiazania_dlugoscwiazania(
    "Fe", "Fe", promienodcieciaFeFe, poczatekFe, koniecFe, poczatekFe, koniecFe)
print()
print()
print()
print("koniec!")
